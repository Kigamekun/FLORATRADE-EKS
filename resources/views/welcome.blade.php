                        ...
                        <div class="getStarted">
                            ...
                            @if (is_null(Auth::user()))
                                <div class="buttonWrapper">
                                    ...
                                    <a href="{{ route('login') }}" class="nav-link">Mulai</a>
                                </div>
        ...
        <div class="container">
            <div class="content">
                <div class="text textSlider">
                    <div class="textSlide">
                        <h1 class="jumbotronText">Mulai bisnis anda sekarang!</h1>
                        <p>Wujudkan impian Anda menjadi eksportir dan importir bersama <span class="brand">Plantsasri Indonesia</span></p>
                        <p>Jasa pengurusan legalitas pengiriman tanaman terlengkap dan terpercaya </p>
                    </div>
                    <div class="textSlide">
                        <h1 class="jumbotronText">Raih kesempatanmu sekarang!</h1>
                        <p>Lakukan yang terbaik di setiap kesempatan yang Anda miliki</p>
                        <p>Jika kamu menginginkan perubahan yang berbeda, mulailah dari dirimu sendiri sekarang juga.</p>
                    </div>
                </div>
    ...
    <div class="mainContent">
        <div class="container">
            ...
            <div class="aboutPlantsasri" id="about">
                ...
                <div class="about">
                    <h1>Tentang kita</h1>
                    <p>Plantsasri Indonesia merupakan salah satu eksportir produk pertanian, khususnya tanaman hias di Indonesia. </p>

                    <p>Plantsasri Indonesia juga peduli dengan seluruh petani Indonesia. Melalui program pengembangan website ini, kami memberikan akses kepada para petani untuk dapat menjangkau pasar global dan memperluas jangkauan bisnis mereka. </p>

                    <p>Plantsasri Indonesia juga memiliki marketplace tanaman hias yang dapat digunakan untuk mengirim dan membeli tanaman hias dan mengirimnya kemanapun mereka inginkan .</p>
                    <div class="statisticAbout">
                        ...
                        <div class="statistic">
                            ...
                            <p>Negara Negara Tujuan</p>
                        </div>
                        <div class="statistic">
                            <span class="count">8</span>
                            <p>Pengusaha Tanaman</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="servicePlantsasri" id="service">
                ...
                <div class="wrapperService">
                    <div class="service">
                        ...
                        <h4>Banyak Tujuan</h4>
                        <p>Banyak negara yang bisa Anda kunjungi untuk mengirim tanaman Anda</p>
                    </div>
                    <div class="service">
                        <div class="iconService">
                        ...
                        <h4>Izin Mudah</h4>
                        <p>Anda dapat mengurus dokumen yang Anda butuhkan untuk perizinan dengan cepat dan mudah</p>
                    </div>
                    <div class="service">
                        <div class="iconService">
                        ...
                        <p>Anda akan mendapatkan pelayanan yang ramah & super hanya di <span class="brand">Plantsasri</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bannerPlantsasri">
                <div class="wrapperBannerPlantsasri">
                    ...
                    <div class="textBanner">
                        ...
                        <h1>PELACAKAN LISENSI TANAMAN ANDA</h1>
                        <p>Fitur Pelacakan Lisensi digunakan untuk memantau proses Phytosanitary Certicifate Anda. Anda dapat memantau
                            proses perizinan Anda kapanpun dan dimanapun Anda berada.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="wrapperCountryAvaialble">
                <div class="content">
                    <div class="text">
                        <h1>Anda dapat mengirim tanaman Anda ke negara-negara ini.</h1>
                    </div>
           ...
           <div class="testimoniSection">
            ...
            <div class="contactSection" id="contact">
                <div class="contact">
                    <h1>Kontak</h1>
                    <p>Jika Anda memiliki pertanyaan tentang saran atau keluhan lisensi, jangan ragu untuk menghubungi
                        kita. Kami akan sangat senang untuk melayani permintaan Anda sesegera mungkin.</p>
                    <form method="POST" action="{{ route('sendMailContact') }}">
                        ...
                        <button type="submit" class="btn buttonSubmit">Kirim</button>
                    </form>
                </div>
                <div id="wrapperMaps">
                    <div id="maps">
        ...
        <div class="container">
            <div class="contentFooter">
                ...
                <div class="line">
                    ...
                    <div class="linkToPages">
                        <p class="address">GARDEN No.13 Jalan Cijahe, Curug Mekar - Bogor Barat, Bogor, Jawa Barat</p>
                    </div>
                </div>
            </div>
            <p class="copyright">© 2021 Plantsasri Indonesia</p>
        </div>
    </footer>
    </div>
