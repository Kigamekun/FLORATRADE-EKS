    ...
    <header class="w-full bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <button class="text-primary font-medium hover:text-primary/80 transition-colors whitespace-nowrap">Login</button>
                <button class="bg-primary text-white px-4 py-2 !rounded-button font-medium hover:bg-primary/90 transition-colors whitespace-nowrap">Sign Up</button>
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-8">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Access to international markets across 30+ countries</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="w-12 h-12 flex items-center justify-center bg-secondary rounded-full mr-4">
                                <i class="ri-shield-check-line ri-lg text-primary"></i>
                            </div>
                            <div>
                                <h4 class="text-lg font-semibold text-gray-900 mb-1">Trusted Service</h4>
                                <p class="text-gray-600">5+ years of export expertise and compliance</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">+62 251 8374 9921</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="w-10 h-10 flex items-center justify-center bg-secondary rounded-full mr-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-white/80 hover:text-white transition-colors">Logistics Solutions</a></li>
                        <li><a href="#" class="text-white/80 hover:text-white transition-colors">Quality Assurance</a></li>
                        <li><a href="#" class="text-white/80 hover:text-white transition-colors">Business Consulting</a></li>
                    </ul>
                </div>
                <!-- Newsletter -->
                <div>
                ...
                [
                    {
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20business%20owner%2C%20male%2C%2040s%2C%20wearing%20a%20smart%20casual%20outfit%2C%20looking%20confident%20and%20approachable%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12347&orientation=squarish'
                    },
                    {
                        name: 'Dewi Anggraini',
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20businesswoman%2C%20early%2030s%2C%20with%20a%20warm%20smile%2C%20wearing%20professional%20attire%2C%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12348&orientation=squarish'
                    },
                    {
                        name: 'Budi Santoso',
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20business%20owner%2C%20male%2C%20mid-30s%2C%20with%20glasses%2C%20wearing%20a%20smart%20casual%20outfit%2C%20looking%20professional%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12349&orientation=squarish'
                    }
                ],
                // Second set
                [
                    {
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20businesswoman%2C%20mid-40s%2C%20wearing%20elegant%20business%20attire%2C%20confident%20pose%2C%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12350&orientation=squarish'
                    },
                    {
                        name: 'Rudi Hartono',
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20business%20professional%2C%20male%2C%20early%2030s%2C%20wearing%20business%20casual%20attire%2C%20friendly%20smile%2C%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12351&orientation=squarish'
                    },
                    {
                        name: 'Linda Kusuma',
                ...
                [
                    {
                        ...
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20executive%2C%20male%2C%20mid-40s%2C%20wearing%20formal%20business%20suit%2C%20confident%20pose%2C%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12353&orientation=squarish'
                    },
                    {
                        name: 'Rina Disa',
                        role: 'Owner, Exotic Flora',
                        text: '"The FloraTrade team is always available to assist us. Their customer service is top-notch, and they genuinely care about our success."',
                        image: 'https://readdy.ai/api/search-image?query=Professional%20headshot%20of%20an%20Indonesian%20businesswoman%2C%20early%2040s%2C%20with%20a%20friendly%20smile%2C%20wearing%20smart-casual%20attire%2C%20against%20a%20neutral%20background.%20High-quality%20portrait%20photography%20with%20good%20lighting.&width=100&height=100&seq=12354&orientation=squarish'
                    },
                ]
            ];
