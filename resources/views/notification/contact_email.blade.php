        ...
        <div class="wrapperContainer" style="margin: auto; width: 100%; max-width: 800px;">
                ...
                <table style="width: 100%; margin-bottom: 2rem;">
                    <tbody>
                        <tr>
                            <td align="center">
                                <div class="icon"
                                    style="background-color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; padding: 1rem; width: max-content;">
                                    <img style="width: 100%; max-width: 52px;"
                                        src="https://i.ibb.co/0jcG7Sv/document-2-1.png" alt="">
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="wrapperBody" style="background: #fff; padding: 1.4rem 3rem; border-radius: 0 0 10px 10px;">
                <div class="text" style="text-align: center; font-family: 'Poppins', sans-serif;">
                    ...
                    <p style="margin: 0;">you Have Message From, <span class="numberRequest"
                            style="color: #2DB878; font-weight: 600;">{{ $data->name }},</span></p>
                ...
                <table style="width: 100%; padding: 1rem 0;">
                    <tbody>
                        <tr>
                            <td align="center">
                                <a href="https://Plantsasri.co.id/"
                                    style="font-family: 'Poppins', sans-serif; background: #2DB878; padding: .8rem 2rem; border-radius: 6px; text-decoration: none; color: #fff;">View
                                    More</a>
                            </td>
                        </tr>
                    </tbody>
